...
import com.dicoding.androidprogramming.submission1jetpackpro.data.source.remote.ApiResponse
...
class CatalogueRepository private constructor(
    ...
    companion object{
        ...
        fun getInstance(remoteDataSource: RemoteDataSource, localData: LocalDataSource, appExecutors: AppExecutors): CatalogueRepository =
            instance ?: synchronized(this){
                instance ?: CatalogueRepository(remoteDataSource, localData, appExecutors)
            }
    }
